...
public class Controller{
    ...
    @FXML
    private Spinner<Integer> SpinSTARTdayOUT;
    @FXML
    ...
    @FXML
    private Spinner<Integer> SpinDELdayOUT;
...
//        SpinDELsecIN.setEditable(true);
        ...
        //OUT
        SpinnerValueFactory<Integer> gradesDay1 = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 31, NOW.getDayOfMonth());
        ...
        SpinnerValueFactory<Integer> gradesDayDEL1 = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 31, 0);
        ...
        SpinSTARTdayOUT.setValueFactory(gradesDay1);
        ...
        SpinDELdayOUT.setValueFactory(gradesDayDEL1);
    ...
    void createFileOutput(ArrayList<Plane> planes, Airline[] airlines, Direction[] directions, ObservableList<TableOUT> table){
        ...
        LocalDateTime bufTime = LocalDateTime.of(SpinSTARTdayOut.getValue(),SpinSTARThourOUT.getValue(), SpinSTARTminOUT.getValue(), SpinSTARTsecOUT.getValue());
